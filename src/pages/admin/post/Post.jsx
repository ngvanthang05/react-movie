...
const TABLE_HEAD = ["Name", "title", "description", "thumbnail", "slug", ""];
    ...
    <div>
      ...
      <div className="h-full w-full overflow-x-auto bg-[#111c44] shadow rounded-lg">
        <table className="w-full min-w-max table-auto text-left border-collapse">
          ...
          <tbody>
            {dataPosts.map(({ id, name, slug, thumbnail, description, title }, index) => {
                ...
                <tr key={id} className="odd:bg-gray-900 even:bg-gray-800 border-b border-gray-700">
                  ...
                  <td className='p-4'>
                    <span className="text-sm font-normal">
                      <div className='w-14 h-12 relative'>
                        <img src={import.meta.env.VITE_ORIGIN_IMAGE + '/post/' + thumbnail} alt={thumbnail} className='rounded-sm' />
                      </div>
                    </span>
                  </td>
                  <td className='p-4'>
                  ...
                  <td className='p-4'>
                    <div className='flex gap-2'>
                      ...
                      <ButtonDetele path={`post/${id}`} label='' />
                    </div>
                  </td>
                </tr>
              );
