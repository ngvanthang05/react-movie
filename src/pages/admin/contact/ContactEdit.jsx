...
const ContactEdit = () => {
    ...
    return (
        <div>
            ...
            <div className='mb-7'>
                <h3 className='text-xl'>Create New Contact</h3>
            </div>
            <form onSubmit={submitAction} className="w-1/2 mx-auto">

                <div>
                    <label htmlFor="name" className="block text-sm font-medium mb-2">Name</label>
                    <input id="name" name="name" type="text" placeholder="Name" defaultValue={dataContact.name}
                ...
                <div className='mt-3'>
                    ...
                    <input id="slug" name="slug" type="text" placeholder="slug" defaultValue={dataContact.slug}
                        className="block w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
                </div>
                
                <div className='mt-3'>
                    <label htmlFor="status" className="block text-sm font-medium mb-2">Status</label>
                    <select id="status" name="status" defaultValue={dataContact.status}
                        className="block w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        {statuses.map((status) => (
                ...
                <div className='mt-3'>
                    ...
                    <PickImage valueImageSrc={dataContact.image} />
                </div>
