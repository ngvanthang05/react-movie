    ...
    <div>
      ...
      <div className="h-full w-full overflow-x-auto bg-[#111c44] shadow rounded-lg">
        <table className="w-full min-w-max table-auto text-left border-collapse">
          ...
          <tbody>
            {dataCategories.map(({ id, name, status, image, slug }, index) => {
              ...
              return (
                <tr key={id} className="odd:bg-gray-900 even:bg-gray-800 border-b border-gray-700">
                  ...
                  <td className='p-4'>
                    <span className="text-sm font-normal">
                      <div className='w-14 h-12 relative'>
                        <img src={import.meta.env.VITE_ORIGIN_IMAGE + '/category/' + image} alt={image} className='rounded-sm' />
                      </div>
                    </span>
                  </td>
                  <td className='p-4'>
                  ...
                  <td className='p-4'>
                    <span className="text-sm font-normal">
                      <SwitchStatus data={{ id, status }} path={'category'} />
                  ...
                  <td className='p-4'>
                    <div className='flex gap-2'>
                      ...
                      <ButtonDetele path={`category`} id={id} label='' />
                    </div>
                  </td>
                </tr>
              );
