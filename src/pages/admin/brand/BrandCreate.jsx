...
const BrandCreate = () => {
    ...
    const submitAction = (event) => {
        ...
        const brand = new FormData(event.target)

        const res = create("brand", brand)
    ...
    return (
        <div>
            ...
            <div className='mb-7'>
                <h3 className='text-xl'>Create New Brand</h3>
            </div>
            <form onSubmit={submitAction} className="w-1/2 mx-auto">
                ...
                <div className='mt-3'>
                    ...
                    <input id="description" name="description" type="text" placeholder="Slug"
                        className="block w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
                </div>
